...
async def triage_urgency(symptoms: str):
    ...
    emergency_criteria = [
        ...
        [
            ...
            # ya estaba. Recomendación Carlos: clasificar como EMERGENCY (turno hoy + derivar si
...
⛔ EL SALUDO VA SIEMPRE PRIMERO EN EL PRIMER MENSAJE: aunque la respuesta sea un flujo específico (obra social, ISSN/derivación externa a CIMO, precio, urgencia), arrancá SIEMPRE con "Hola 😊 Soy {bot_name}, del equipo de {clinic_name}." y DESPUÉS el contenido del flujo — NUNCA arranques seco con "Para cirugía..." ni directo con el mensaje del flujo. El saludo + presentación va una sola vez, al inicio.
"""
