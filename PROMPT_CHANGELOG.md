...
| 2026-07-02 | (pendiente) | main.py · REGLA GESTIÓN PREVIA SIN REGISTRO (~11473-11480) — cobertura de ESTUDIOS/PLACAS/RESULTADOS | Amplía el disparador a consultas de ESTADO/LLEGADA ("¿llegaron mis placas?", "¿están mis resultados?", "¿ya llegó mi estudio?"). Aclara: para estudios/placas NO hay tool que los busque → revisar ficha/contexto y si no figura, DERIVAR. PROHIBIDO pedirle que "reenvíe/remande" algo que dice haber dejado (solo recibir si ofrece uno NUEVO). Motivo/mensaje de derivación generalizados (placas/estudio/resultado, no solo presupuesto) | Caso real Lucas: preguntó "¿llegaron mis placas?" y el bot improvisó "reenviámelas y las revisamos por acá" en vez de derivar al equipo. La regla de Manuel cubría presupuestos pero no las consultas de estado de estudios | `git revert <pendiente>` |
