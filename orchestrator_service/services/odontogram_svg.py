...
PRINT_FILLS = {
    ...
    # Preexistente
    "implante":              {"fill": "#dbeafe", "stroke": "#2563eb"},
    "radiografia":           {"fill": "#fef3c7", "stroke": "#d97706"},
    "restauracion_resina":   {"fill": "#fef3c7", "stroke": "#d97706"},
    "restauracion_amalgama": {"fill": "#d1d5db", "stroke": "#4b5563"},
    "restauracion_temporal": {"fill": "#fef9c3", "stroke": "#b45309"},
    "sellador_fisuras":      {"fill": "#fef9c3", "stroke": "#b45309"},
    "carilla":               {"fill": "#ede9fe", "stroke": "#7c3aed"},
    "puente":                {"fill": "#dbeafe", "stroke": "#2563eb"},
    "corona_porcelana":      {"fill": "#dbeafe", "stroke": "#1d4ed8"},
    "corona_resina":         {"fill": "#fce7f3", "stroke": "#db2777"},
    "corona_metalceramica":  {"fill": "#fef3c7", "stroke": "#b45309"},
    "corona_temporal":       {"fill": "#fef3c7", "stroke": "#b45309"},
    "incrustacion":          {"fill": "#fef3c7", "stroke": "#d97706"},
    "onlay":                 {"fill": "#fef3c7", "stroke": "#b45309"},
    "poste":                 {"fill": "#ffedd5", "stroke": "#c2410c"},
    "perno":                 {"fill": "#d1d5db", "stroke": "#525252"},
    "fibras_ribbond":        {"fill": "#ede9fe", "stroke": "#7c3aed"},
    "tratamiento_conducto":  {"fill": "#ffedd5", "stroke": "#c2410c"},
    "protesis_removible":    {"fill": "#dbeafe", "stroke": "#2563eb"},
    "diente_erupcion":       {"fill": "#ffedd5", "stroke": "#c2410c"},
    "diente_no_erupcionado": {"fill": "#ffedd5", "stroke": "#c2410c"},
    "ausente":               {"fill": "#e5e7eb", "stroke": "#6b7280"},
    "otra_preexistencia":    {"fill": "#ffedd5", "stroke": "#c2410c"},
    "treatment_planned":     {"fill": "#fef08a", "stroke": "#ca8a04"},
    # Lesion
    "mancha_blanca":         {"fill": "#fffbeb", "stroke": "#d97706"},
    "surco_profundo":        {"fill": "#ffedd5", "stroke": "#c2410c"},
    "caries":                {"fill": "#fecaca", "stroke": "#991b1b"},
    "caries_penetrante":     {"fill": "#fecaca", "stroke": "#7f1d1d"},
    "necrosis_pulpar":       {"fill": "#d1d5db", "stroke": "#111827"},
    "proceso_apical":        {"fill": "#fecaca", "stroke": "#b91c1c"},
    "fistula":               {"fill": "#fed7aa", "stroke": "#c2410c"},
    "indicacion_extraccion": {"fill": "#fecaca", "stroke": "#b91c1c"},
    "abrasion":              {"fill": "#fef9c3", "stroke": "#a16207"},
    "abfraccion":            {"fill": "#fef9c3", "stroke": "#a16207"},
    "atricion":              {"fill": "#fef9c3", "stroke": "#a16207"},
    "erosion":               {"fill": "#ffedd5", "stroke": "#c2410c"},
    "fractura_horizontal":   {"fill": "#fecaca", "stroke": "#b91c1c"},
    "fractura_vertical":     {"fill": "#fecaca", "stroke": "#b91c1c"},
    "movilidad":             {"fill": "#fce7f3", "stroke": "#db2777"},
    "hipomineralizacion_mih":{"fill": "#fef9c3", "stroke": "#a16207"},
    "otra_lesion":           {"fill": "#ffedd5", "stroke": "#c2410c"},
    # Legacy aliases
    "restoration":       {"fill": "#fef3c7", "stroke": "#d97706"},
    "root_canal":        {"fill": "#ffedd5", "stroke": "#c2410c"},
    "crown":             {"fill": "#dbeafe", "stroke": "#1d4ed8"},
    "implant":           {"fill": "#dbeafe", "stroke": "#2563eb"},
    "prosthesis":        {"fill": "#dbeafe", "stroke": "#2563eb"},
