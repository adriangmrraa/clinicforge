...
class ChatMessage(Base):
    ...
    content_attributes = Column(JSONB, server_default=text("'[]'::jsonb"))
    platform_metadata = Column(JSONB, server_default=text("'{}'::jsonb"))
...
class Tenant(Base):
    ...
    working_hours = Column(JSONB, server_default=text("'{}'::jsonb"))
...
class Patient(Base):
    ...
    # Medical
    medical_history = Column(JSONB, server_default=text("'{}'::jsonb"))
...
class ClinicalRecord(Base):
    ...
    odontogram = Column(JSONB, server_default=text("'{}'::jsonb"))
    odontogram_data = Column(JSONB, server_default=text("'{}'::jsonb"))
    diagnosis = Column(Text)
    treatments = Column(JSONB, server_default=text("'[]'::jsonb"))
    radiographs = Column(JSONB, server_default=text("'[]'::jsonb"))
    treatment_plan = Column(JSONB, server_default=text("'{}'::jsonb"))
...
class PatientDocument(Base):
    ...
    source_details = Column(JSONB, server_default=text("'{}'::jsonb"))
...
class AutomationRule(Base):
    ...
    condition_json = Column(JSONB, server_default=text("'{}'::jsonb"))
    ...
    ycloud_template_vars = Column(JSONB, server_default=text("'{}'::jsonb"))
...
class MetaFormLead(Base):
    ...
    custom_questions = Column(JSONB, server_default=text("'{}'::jsonb"))
    ...
    attribution_data = Column(JSONB, server_default=text("'{}'::jsonb"))
    webhook_payload = Column(JSONB, server_default=text("'{}'::jsonb"))
