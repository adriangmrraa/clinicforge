      ...
      - generic [ref=e524]:
        ...
        - generic [ref=e2419]:
          - generic [ref=e2420]:
            - generic [ref=e2421]:
              - generic [ref=e2422]:
                - heading "Editar Turno" [level=2] [ref=e2423]
                - generic [ref=e2424]: Manual
              - paragraph [ref=e2425]: Inspector Clínico
            - button "Cerrar" [ref=e2426] [cursor=pointer]:
              - img [ref=e2427]
          - generic [ref=e2430]:
            - button "General" [ref=e2431] [cursor=pointer]:
              - img [ref=e2432]
              - text: General
            - button "Anamnesis" [ref=e2435] [cursor=pointer]:
              - img [ref=e2436]
              - text: Anamnesis
            - button "Facturación" [ref=e2438] [cursor=pointer]:
              - img [ref=e2439]
              - text: Facturación
          - generic [ref=e2442]:
            - generic [ref=e2443]:
              ...
              - generic [ref=e2444]:
                - img [ref=e2445]
                - generic [ref=e2448]: Antonella Cursaro
            - generic [ref=e2449]:
              - text: Profesional
              - generic [ref=e2450]:
                - img [ref=e2451]
                - combobox [ref=e2454] [cursor=pointer]
            - generic [ref=e2455]:
              - generic [ref=e2456]:
                - text: Fecha y Hora
                - generic [ref=e2457]
            ...
            - generic [ref=e2467]:
              - text: Tipo de Turno
              - generic [ref=e2468]:
                - button "ATM" [ref=e2469] [cursor=pointer]
                - button "Blanqueamiento Diamante" [ref=e2470] [cursor=pointer]
                - button "Carillas/Estetica Anterior" [ref=e2471] [cursor=pointer]
                - button "Cirugía Compleja" [ref=e2472] [cursor=pointer]
                - button "Cirugía Simple" [ref=e2473] [cursor=pointer]
                - button "Consulta General" [ref=e2474] [cursor=pointer]
                - button "Consulta Urgencia" [ref=e2475] [cursor=pointer]
                - button "Control Ortodoncia" [ref=e2476] [cursor=pointer]
                - button "Control / Revisión" [ref=e2477] [cursor=pointer]
                - button "Endodoncia" [ref=e2478] [cursor=pointer]
                - button "Endolifting" [ref=e2479] [cursor=pointer]
                - button "Estética Facial Avanzada" [ref=e2480] [cursor=pointer]
                - button "Estética Facial Simple" [ref=e2481] [cursor=pointer]
                - button "Implante Complejo (Protocolo CIMA)" [ref=e2482] [cursor=pointer]
                - button "Implante Guiado Tomográficamente" [ref=e2483] [cursor=pointer]
                - button "Implante Simple (Protocolo RISA)" [ref=e2484] [cursor=pointer]
                - button "Injerto / Regeneración Ósea" [ref=e2485] [cursor=pointer]
                - button "Limpieza Dental" [ref=e2486] [cursor=pointer]
                - button "Ortodoncia" [ref=e2487] [cursor=pointer]
                - button "Rehabilitación Compleja" [ref=e2488] [cursor=pointer]
                - button "Rehabilitación Integral" [ref=e2489] [cursor=pointer]
                - button "Rehabilitación Simple" [ref=e2490] [cursor=pointer]
                - button "Restauración Compleja" [ref=e2491] [cursor=pointer]
                - button "Restauración Simple" [ref=e2492] [cursor=pointer]
            - generic [ref=e2493]:
              - text: Estado del Turno
              - paragraph [ref=e2494]: Cambiar a "Completada" enviará un mensaje de feedback al paciente en 45 minutos.
              - generic [ref=e2495]:
                - button "📅 Programado" [ref=e2496] [cursor=pointer]
                - button "✅ Confirmado" [ref=e2497] [cursor=pointer]
                - button "🏁 Completada" [ref=e2498] [cursor=pointer]
                - button "❌ Cancelado" [ref=e2499] [cursor=pointer]
                - button "👻 No asistió" [ref=e2500] [cursor=pointer]
            - generic [ref=e2501]:
              - text: Notas
              - textbox "Notas adicionales..." [ref=e2502]: consulta cirugía- osde coseg. 20 mil
          - generic [ref=e2503]:
            - button [ref=e2504] [cursor=pointer]:
              - img [ref=e2505]
            - generic [ref=e2508]:
              - button "Cancelar" [ref=e2509] [cursor=pointer]
              - button "Guardar Cambios" [ref=e2510] [cursor=pointer]:
                - img [ref=e2511]
